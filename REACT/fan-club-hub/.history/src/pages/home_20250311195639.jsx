...
const artists = ['Taylor Swift', 'Beyoncé', 'Drake','Rush','James Taylor','Wallflowers', 'Queensrÿche','Eric Clapton', 'Stevie Ray Van', 'George Strait', 'LadtAntebellum','Fleetwood Mac','Heart'];
