...
const artists = ['Taylor Swift', 'Beyoncé', 'Drake','Rush','James Taylor','Wallflowers', 'Queensrÿche','Eric Clapton', 'Stevie Ray Vaughan', 'George Strait', 'Lady Antebellum','Fleetwood Mac','Heart', '3 Doors Down', 'Daughtry','Crosby Stills and Nash','Neal Young','Extreme','Corrs','Scorpions','38 Special', 'Aerosmith','Black Crows','Queens of the Stone Age','Styx','Boston'
];
