...
function Artist() {
  ...
  const unsplashApiKey = 'Q4pZ6yHZJvh40VRj9Dxj2IPQC5tMohcVb34lGOVn-kM';
  const unspashSecretKey = '5p9PdqCrOXMafWRPoz_cFO5sxGtZC8-uVSCswGo1mEQ';
  const lastFmApiKey = '0447213284e7a8e7555d1cd4eb47f2a5';
  const lastFmSecretKey   = '35716806a88b2cc220cc78118574c959';
  // Fetch artist image
  useEffect(() => {
