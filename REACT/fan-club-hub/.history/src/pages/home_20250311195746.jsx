...
const artists = ['Taylor Swift', 'Beyoncé', 'Drake','Rush','James Taylor','Wallflowers', 'Queensrÿche','Eric Clapton', 'Stevie Ray Van', 'George Strait', 'Lady Antebellum','Fleetwood Mac','Heart', '3 Doors Down', Daug];
